...
class Door(GameObject):
    def __init__(self, room1_id, room1_location, room2_id, room2_locaiton, name, description, is_locked, key_item_id):
        super().__init__('door', name, description)
        self.room1_id = room1_id
        self.room1_locaion = room1_location
        self.room2_id = room2_id
        self.room2_locaiton = room2_locaiton
    ...
    def inspect(self, room_id):
        ...
        if room_id == self.room1_id:
            door_location = self.room1_locaion
        elif room_id == self.room2_id:
            door_location = self.room2_locaiton
    ...
    def to_json(self):
        return {
            ...
            "room2_locaiton": self.room2_locaiton,
    ...
    def from_dict(cls, data):
        return cls(
            ...
            room2_locaiton=data.get("room1_location", ""),
            name=data.get("name", ""),
